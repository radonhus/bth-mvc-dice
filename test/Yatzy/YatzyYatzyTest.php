...
class YatzyYatzyTest extends TestCase
{
    ...
    public function testIsInstanceOfRound()
    {
        ...
        $this->assertInstanceOf("riax20\Yatzy\Yatzy", $yatzyObject);
    }
    ...
    {
        $publicReRoll = new ReflectionMethod('riax20\Yatzy\Yatzy', 'reRoll');
    ...
    {
        $publicCalc = new ReflectionMethod('riax20\Yatzy\Yatzy', 'calculatePoints');
